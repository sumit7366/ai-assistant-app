...
AI Personal Assistant is a modern web application that combines face recognition technology with voice feedback to create an interactive and personalized user experience. The application uses Flask for the backend and cutting-edge web APIs for real-time face detection and text-to-speech capabilities.

**Live Demo:** https://ai-assistant.onrender.com  
...
- **🤖 Smart Face Recognition** - Real-time face detection using camera with personalized voice feedback
- **🗣️ Text-to-Speech** - Browser speech synthesis for personalized descriptions
- **📸 Image Upload** - Upload photos from gallery or camera with descriptions
- **🔒 Privacy First** - Local data storage with encryption and no cloud uploads
- **💾 Local Database** - JSON-based data persistence
- **📱 Responsive Design** - Fully functional on Mobile, Tablet, and Desktop
- **🎤 Speech API** - Browser-based voice feedback
- **📷 WebRTC Camera** - Real-time camera access and processing
- **📧 Email Support** - Gmail integration for support requests
...
│   ├── camera.html                # Face recognition interface
...
2. **Sign up on Render.com** and create a new Web Service
...
- **Database:** Local JSON files in `data/` directory
...
| Upload failures | Verify file size (max 16MB) and format compatibility |
| Mobile menu issues | Clear browser cache and check JavaScript console |
| Application sleeping | Free tier on Render sleeps after 15 mins inactivity |
...
- **Email Support** - sumitranjanhisu@gmail.com
- **In-app Support Form** - Use the support page in the application
...
- **Session Based:** Automatic session expiration for security
- **Open Source:** Transparent code with nothing hidden
...
Portfolio: [(https://sumitkportfoliodev.netlify.app/)]
